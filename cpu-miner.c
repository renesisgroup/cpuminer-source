...
#define YES "yes, where are them gold diggers?!!"
#define YAY "Oooh shiny!!!"
#define BOO "Ouch! rejected. booooo!"
...
{
	printf("\n\n");
	printf("** " PACKAGE_NAME " " PACKAGE_VERSION " algo ported by hav0k, Renesis Project **\n");
	printf("Warning! Please use moderate mining threads not to overload your system\n");
	printf("Visit renesisgroup on github for latest updates on commits \n");
	printf("Greets and much respect to mrM4D & ocminer on #ccminer at irc.freenode.net \n");
	printf("Web: www.renesis.io \n\n");
	printf("Here we go ... \n");
}
